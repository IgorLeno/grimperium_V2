...
class MoleculeResults:
    ...
    # CREST results
    crest_status: Optional[str] = None
    """CREST execution status."""

    crest_conformers_generated: Optional[int] = None
    ...
    # MOPAC results
    mopac_status: Optional[str] = None
    """MOPAC execution status."""

    mopac_time: Optional[float] = None
    ...
    most_stable_hof: Optional[float] = None
